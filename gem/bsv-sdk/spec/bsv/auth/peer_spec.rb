...
RSpec.describe BSV::Auth::Peer do
  ...
  describe '#last_interacted_peer' do
    ...
    it 'is not overwritten on initial request if already set (responder side)' do
      carol_wallet = BSV::Wallet::Client.new(BSV::Primitives::PrivateKey.generate, storage: BSV::Wallet::MemoryStore.new)
  ...
  describe '#create_certificate_response (private, low-level builder)' do
    let(:certifier_wallet) { BSV::Wallet::Client.new(BSV::Primitives::PrivateKey.generate, storage: BSV::Wallet::MemoryStore.new) }
