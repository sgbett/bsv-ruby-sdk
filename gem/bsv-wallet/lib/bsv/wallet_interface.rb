...
module BSV
  module Wallet
    ...
    autoload :LegacyChainProviderAdapter, 'bsv/wallet_interface/adapters/legacy_chain_provider_adapter'
    autoload :LegacyBroadcasterAdapter,   'bsv/wallet_interface/adapters/legacy_broadcaster_adapter'
    autoload :RegistryBroadcaster,        'bsv/wallet_interface/adapters/registry_broadcaster'
    autoload :RegistryChainTracker,       'bsv/wallet_interface/adapters/registry_chain_tracker'
