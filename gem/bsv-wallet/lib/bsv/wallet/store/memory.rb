...
module BSV
  module Wallet
    module Store
      ...
      # This makes Store::Memory safe within a single Ruby process.
      #
      # NOTE: Store::File is NOT process-safe — concurrent processes share no
      ...
      class Memory
        ...
        def initialize
          ...
          warn '[bsv-wallet] Store::Memory is intended for testing only. ' \
        ...
        # environment and the operator has not explicitly acknowledged Store::Memory
        ...
        # a JSON round-trip in Store::File); both are normalised to a Symbol here.
        #
        # Legacy mapping:
