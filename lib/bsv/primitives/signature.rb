  ...
  module Primitives
    ...
    class Signature
      ...
      def self.from_der(der_bytes)
        ...
        raise ArgumentError, 'R has excessive padding' if r_len > 1 && r_bytes[0].zero? && (r_bytes[1] & 0x80).zero?
        ...
        raise ArgumentError, 'S has excessive padding' if s_len > 1 && s_bytes[0].zero? && (s_bytes[1] & 0x80).zero?
