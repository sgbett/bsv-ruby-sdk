...
The SDK has **no external dependencies** — it uses only Ruby's standard library. Elliptic curve operations are pure Ruby; OpenSSL is used only for hashing and symmetric encryption.
