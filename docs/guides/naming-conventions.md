...
This is enforced in the project's RuboCop configuration. Methods in `lib/bsv/wallet_interface/` are exempt from the `Naming/AccessorMethodName` and `Naming/PredicatePrefix` cops for this reason.
