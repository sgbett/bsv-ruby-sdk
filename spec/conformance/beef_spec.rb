...
#
# Cross-validates the Ruby SDK's BEEF implementation against test vectors
# and expected values from the Go and TypeScript reference SDKs.
#
# Source vectors:
#   Go SDK:  transaction/beef_test.go (BRC62Hex, BEEFSet)
#   TS SDK:  src/transaction/__tests/Beef.test.ts

RSpec.describe BSV::Transaction::Beef do
  # --- Go SDK test vector: BRC-62 (V1) ---
  # Source: go-sdk/transaction/beef_test.go const BRC62Hex
  let(:go_brc62_hex) do
  ...
  # --- Go SDK test vector: BRC-96 (V2) ---
  # Source: go-sdk/transaction/beef_test.go const BEEFSet
  let(:go_beef_set_hex) do
