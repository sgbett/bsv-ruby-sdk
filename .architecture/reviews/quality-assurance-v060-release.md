...
1. ~~**Regenerate YARD reference docs**~~ — **Done.** YARD reference docs are generated by the GitHub Actions docs deployment workflow on merge. The updated `curve.rb` docstring will be picked up automatically. No manual action needed.

2. ~~**Add secp256k1 to MkDocs navigation**~~ — **Done.** Added `about/secp256k1.md` under a new "About" section in `mkdocs.yml`.
...
1. ~~**Stale auto-generated docs**~~ — **Resolved.** YARD docs regenerate automatically via GitHub Actions on merge. MkDocs nav updated to include secp256k1 page.
...
- [x] YARD reference docs — regenerated automatically by CI on merge
- [x] MkDocs navigation updated — secp256k1 page added under "About"
